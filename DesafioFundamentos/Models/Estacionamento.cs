namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            Console.WriteLine($"O veículo de placa {veiculoAdicionado} foi adicionado com sucesso!");
        }
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == veiculoRemovido.ToUpper()))
            {
                ...
                Console.WriteLine($"O veículo {veiculoRemovido} foi removido e o preço total foi de: R$ {valorTotal:C}");
            }
            else
            {
